...
This is a comparison of what brands people of each future temple location prefer. We feel that the presence of certain "brands" can indicate a certain level of economic stability, so this is an example of how we can use the SafeGraph data to analyze the patterns of each area to get a sense of what "brands" are most popular and/or available to the local population.
